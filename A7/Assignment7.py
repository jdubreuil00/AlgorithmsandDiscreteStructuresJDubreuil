...
if __name__ == "__main__":
    ...
    print("================Exercise 1=================")
    print(Mean(Atest, 5)) #From Example Result 1
    print(Mean(A1, 11)) #Result 60.45454545454545
    print(Mean(A2, 10)) #Result 13.68
    # Descend Sorted Binary search function calls for the assignment.
    print("================Exercise 2=================")
    print(DescendSortBinarySearch(Atest2, 0, len(Atest2)-1, 27))#From Example Result 2
    print(DescendSortBinarySearch(A3, 0, len(A3)-1, 87))#Result Index 1 
    print(DescendSortBinarySearch(A3, 0, len(A3)-1, 48))#Result Index 8
    print(DescendSortBinarySearch(A3, 0, len(A3)-1, 33))#Result None
    print(DescendSortBinarySearch(A3, 0, len(A3)-1, 10))#Result None
    print("================Exercise 3=================")
    # GCD function calls for assignment.
    print(GCD(144, 42)) #From Example Result 6
    print(GCD(2468, 1357))#Result 1
    print(GCD(111, 378))#Result 3
    print(GCD(123456789, 987654321))#Result 9
